...
---------------------------
Since the 4.x branch has migrated from Visualization API to Charts, it is recommended that Commerce Reports 3.x is disabled and uninstalled. It is recommended that you check your active views (admin/structure/views) and ensure all of Commerce Reports' views have been removed.
