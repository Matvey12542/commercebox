 ...
 */
function commercebox_form_install_configure_form_alter(&$form, $form_state) {
  ...
  $form['actions']['submit']['#validate'][] = 'commercebox_form_install_configure_form_validate';
 ...
 */
function commercebox_form_install_configure_form_validate($form, &$form_state) {
  if (!form_get_errors()) {
